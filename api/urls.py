...
urlpatterns = [
    ...
    path("orders/month", views.OrdersThisMonth.as_view(), name='OrderThisMonth'),
    ...
    path('orders/week', views.OrdersThisweek.as_view(), name='OrdersThisWeek'),
    ...
    path('orders/addtask/<int:order_Id>/', views.OrderAddTask.as_view(), name='OrderAddTask'),
]